...
- Visual baselines live under `data/visual-baselines/` and keep the Playwright-generated PNG names.
...
- Use `data/visual-baselines/` for approved screenshot baselines generated by Playwright.
